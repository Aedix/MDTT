  ...
  <template id="citizenPanelTemplate">
    <div class="citizen-panel-inner" data-editing="1">
      ...
      <div class="citizen-tab-panels">
        ...
        <section class="citizen-tab-panel" data-panel="notes"><div class="form-grid compact-form"><label>Notes internes<textarea id="notes" rows="9"></textarea></label></div></section>
      </div>
